...
import { AiOutlineColumnWidth, AiOutlineExport } from "react-icons/ai";
    ...
    <>
      ...
      {loading && (
        <div className="w-full flex align-middle items-center justify-center">
          <svg
            role="status"
            className="w-16 h-16 mb-4 text-gray-200 animate-spin dark:text-gray-600 fill-gray-600 dark:fill-gray-300"
            viewBox="0 0 100 101"
            fill="none"
      ...
      {!loading && (
        <div className="w-full flex align-middle items-center justify-center mb-6">
          <button
            className="w-96 bg-blue-500 hover:bg-blue-700 text-white font-bold py-4 px-6"
            onClick={() =>
              fetchMore({
                variables: {
